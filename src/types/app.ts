export type LLMProvider = 'claude' | 'cursor' | 'codex' | 'opencode' | 'deepseek' | 'orchestration';
...
export type AppTab = 'chat' | 'files' | 'shell' | 'git' | 'tasks' | 'browser' | 'preview' | 'prd' | `plugin:${string}`;
